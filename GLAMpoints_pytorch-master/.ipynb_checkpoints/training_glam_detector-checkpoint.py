...
def main():
    ...
    train_dir = '/Users/danaawamleh/Desktop/JKU/Practical/FIRE/Images/train'
    valid_dir = '/Users/danaawamleh/Desktop/JKU/Practical/FIRE/Images/valid'
    train_dataset = SyntheticDataset(train_dir, train=True)
    val_dataset = SyntheticDataset(valid_dir, train=False)
    ...
    #    axes[0].imshow(data['image1'][1][0].numpy(), cmap='gray') 
    #    axes[0].set_title('Input Image')
    #    axes[0].axis('off')  
    #    shape_I = data['image1'][0]
    #    shape_I_ = data['image2'][0].shape
    #    axes[1].imshow(data['image2'][1][0].numpy(), cmap='gray') 
    #    axes[1].set_title('Transformed Image')
    #    axes[1].axis('off') 
    #print(f"shape image I: {shape_I}")
    #print(f"shape image I': {shape_I_}")
    # defines the model
    model = UNet()
